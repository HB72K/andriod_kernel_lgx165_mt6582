...
void S5K5E2FR_MIPI_read_otp_wb(struct S5K5E2FR_MIPI_otp_struct *otp)
{
	...
	{
		SENSORDB("[S5K5E2FR] [S5K5E2FR_MIPI_read_otp_wb] PageCount=%d\n", PageCount);	
		S5K5E2FR_bytewrite_cmos_sensor(0x3a02, PageCount); //page set
		S5K5E2FR_bytewrite_cmos_sensor(0x3a00, 0x01); //otp enable read
		R_to_G = (S5K5E2FR_read_cmos_sensor(0x3a09)<<8)+S5K5E2FR_read_cmos_sensor(0x3a0a);
		B_to_G = (S5K5E2FR_read_cmos_sensor(0x3a0b)<<8)+S5K5E2FR_read_cmos_sensor(0x3a0c);
		G_to_G = (S5K5E2FR_read_cmos_sensor(0x3a0d)<<8)+S5K5E2FR_read_cmos_sensor(0x3a0e);
		S5K5E2FR_bytewrite_cmos_sensor(0x3a00, 0x00); //otp disable read

		if((R_to_G != 0) && (B_to_G != 0) && (G_to_G != 0))
			break;	

		if(PageCount == 1)
			SENSORDB("[S5K5E2FR] [S5K5E2FR_MIPI_read_otp_wb] otp all value is zero");
	}

	otp->R_to_G = R_to_G;
	otp->B_to_G = B_to_G;
	otp->G_to_G = 0x400;
	SENSORDB("[S5K5E2FR] [S5K5E2FR_MIPI_read_otp_wb] otp->R_to_G=0x%x\n", otp->R_to_G);	
	SENSORDB("[S5K5E2FR] [S5K5E2FR_MIPI_read_otp_wb] otp->B_to_G=0x%x\n", otp->B_to_G);	
	SENSORDB("[S5K5E2FR] [S5K5E2FR_MIPI_read_otp_wb] otp->G_to_G=0x%x\n", otp->G_to_G);	
}
...
void S5K5E2FR_MIPI_algorithm_otp_wb1(struct S5K5E2FR_MIPI_otp_struct *otp)
{
	...
	SENSORDB("[S5K5E2FR] [S5K5E2FR_MIPI_read_otp_wb] R_to_G=%d\n", R_to_G);	
	SENSORDB("[S5K5E2FR] [S5K5E2FR_MIPI_read_otp_wb] B_to_G=%d\n", B_to_G);	
	SENSORDB("[S5K5E2FR] [S5K5E2FR_MIPI_read_otp_wb] G_to_G=%d\n", G_to_G);
	...
	SENSORDB("[S5K5E2FR] [S5K5E2FR_MIPI_read_otp_wb] R_gain=0x%x\n", otp->R_Gain);	
	SENSORDB("[S5K5E2FR] [S5K5E2FR_MIPI_read_otp_wb] B_gain=0x%x\n", otp->B_Gain);	
	SENSORDB("[S5K5E2FR] [S5K5E2FR_MIPI_read_otp_wb] G_gain=0x%x\n", otp->G_Gain);
}
...
void S5K5E2FR_MIPI_write_otp_wb(struct S5K5E2FR_MIPI_otp_struct *otp)
{
	...
	SENSORDB("[S5K5E2FR] [S5K5E2FR_MIPI_read_otp_wb] R_GainH=0x%x\n", R_GainH);	
	SENSORDB("[S5K5E2FR] [S5K5E2FR_MIPI_read_otp_wb] R_GainL=0x%x\n", R_GainL);	
	SENSORDB("[S5K5E2FR] [S5K5E2FR_MIPI_read_otp_wb] B_GainH=0x%x\n", B_GainH);
	SENSORDB("[S5K5E2FR] [S5K5E2FR_MIPI_read_otp_wb] B_GainL=0x%x\n", B_GainL);	
	SENSORDB("[S5K5E2FR] [S5K5E2FR_MIPI_read_otp_wb] G_GainH=0x%x\n", G_GainH);	
	SENSORDB("[S5K5E2FR] [S5K5E2FR_MIPI_read_otp_wb] G_GainL=0x%x\n", G_GainL);
	...
	SENSORDB("[S5K5E2FR] [S5K5E2FR_MIPI_read_otp_wb] [0x020e,0x%x]\n", S5K5E2FR_read_cmos_sensor(0x020e));	
	SENSORDB("[S5K5E2FR] [S5K5E2FR_MIPI_read_otp_wb] [0x020f,0x%x]\n", S5K5E2FR_read_cmos_sensor(0x020f));	
	SENSORDB("[S5K5E2FR] [S5K5E2FR_MIPI_read_otp_wb] [0x0210,0x%x]\n", S5K5E2FR_read_cmos_sensor(0x0210));
	SENSORDB("[S5K5E2FR] [S5K5E2FR_MIPI_read_otp_wb] [0x0211,0x%x]\n", S5K5E2FR_read_cmos_sensor(0x0211));	
	SENSORDB("[S5K5E2FR] [S5K5E2FR_MIPI_read_otp_wb] [0x0212,0x%x]\n", S5K5E2FR_read_cmos_sensor(0x0212));	
	SENSORDB("[S5K5E2FR] [S5K5E2FR_MIPI_read_otp_wb] [0x0213,0x%x]\n", S5K5E2FR_read_cmos_sensor(0x0213));
	SENSORDB("[S5K5E2FR] [S5K5E2FR_MIPI_read_otp_wb] [0x0214,0x%x]\n", S5K5E2FR_read_cmos_sensor(0x0214));	
	SENSORDB("[S5K5E2FR] [S5K5E2FR_MIPI_read_otp_wb] [0x0215,0x%x]\n", S5K5E2FR_read_cmos_sensor(0x0215));
}
...
void S5K5E2FRPreviewSetting(void)
{
   ...
   S5K5E2FR_bytewrite_cmos_sensor(0x320C,0x07); // ADC_MAX (def:076Ch --> 0700h)
   S5K5E2FR_bytewrite_cmos_sensor(0x320D,0x00); 																	  
   S5K5E2FR_bytewrite_cmos_sensor(0x3400,0x01); // GAS bypass
   S5K5E2FR_bytewrite_cmos_sensor(0x3235,0x49); // L/F-ADLC on
   S5K5E2FR_bytewrite_cmos_sensor(0x3233,0x00); // D-pedestal L/F ADLC off (1FC0h)
   S5K5E2FR_bytewrite_cmos_sensor(0x3234,0x00);
   S5K5E2FR_bytewrite_cmos_sensor(0x3300,0x0C); //BPC On
...
//<2015/01/21-joubert.she-[V10][Feature][Common][BSP][][] 5M camera capture delay modification
