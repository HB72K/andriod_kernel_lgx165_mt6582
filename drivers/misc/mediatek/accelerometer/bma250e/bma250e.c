...
#define BMA255_DEV_NAME        "BMA250E"

#define BMA255_MODE_NORMAL      0
#define BMA255_MODE_LOWPOWER    1
#define BMA255_MODE_SUSPEND     2
//for bma250e chip.
#define BMA255_ACC_X_LSB__POS           6//4
#define BMA255_ACC_X_LSB__LEN           2//4
...
#define BMA255_ACC_Y_LSB__POS           6//4
#define BMA255_ACC_Y_LSB__LEN           2//4
...
#define BMA255_ACC_Z_LSB__POS           6//4
#define BMA255_ACC_Z_LSB__LEN           2//4
...
static struct i2c_board_info __initdata bma255_i2c_info ={ I2C_BOARD_INFO(BMA255_DEV_NAME, BMA250E_I2C_ADDR)};
...
/*----------------------------------------------------------------------------*/
static struct data_resolution bma255_offset_resolution = {{3, 9}, 256};
