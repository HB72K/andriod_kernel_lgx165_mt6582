...
#define LENSPFX "FM50-Lens"
#define FM50_DBG_FUNC(fmt, arg...)    xlog_printk(ANDROID_LOG_ERROR, LENSPFX , fmt, ##arg) //
...
#define FM50AF_DEBUG
#ifdef FM50AF_DEBUG
#define FM50AFDB FM50_DBG_FUNC //pr_debug
#else
#define FM50AFDB(x, ...)
#endif
...
static int DW9714A_Mode_Init(int a)
{
    ...
    FM50AFDB("[DW9714A] DW9714A_Mode_Init \n");
    ...
    if (i4RetValue < 0) 
    {
        FM50AFDB("[DW9714A] I2C send failed!! \n");
    }
