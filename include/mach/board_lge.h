...
#elif( defined(CONFIG_MACH_MT6582) || defined( CONFIG_ARCH_MT6582 ))
...
/*                                                                                   */
#if defined(DEVICES_LGE_C)
int g_AtCmdChargeMode;//for at%charge
int g_AtCmdUsbId;     //for at%usbiadc
int g_AtCmdUsbAdc;    //for at%usbiadc
#else
