...
#### hb72k@Huawei:~/KERNEL_COMPILE$ ls
...
KERNEL_DIR=$PWD
KERNEL_DEFCONFIG=v10_defconfig
KERNEL_TOOLCHAIN=/home/hb72k/arm-eabi-4.8/bin/arm-eabi-
MAKE_JOBS=10
ANY_KERNEL2_DIR=/home/hb72k/AnyKernel2/
...
$KERNEL_DIR/arch/arm/boot/dt.img -s 2048 -p $KERNEL_DIR/scripts/dtc/ $KERNEL_DIR/arch/arm/boot/dts/
