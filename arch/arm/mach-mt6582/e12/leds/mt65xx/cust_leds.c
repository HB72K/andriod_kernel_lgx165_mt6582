...
#include <leds-lm3533.h>  //20140422 tracy modify for backlight control
...
static struct cust_mt65xx_led cust_led_list[MT65XX_LED_TYPE_TOTAL] = {
	{"red",               MT65XX_LED_MODE_CUST_BLS_PWM, (int)lm3533_red_brightness_control,{0}},  //20140530 tracy modify for rgb led++
	{"green",             MT65XX_LED_MODE_CUST_BLS_PWM, (int)lm3533_green_brightness_control,{0}},
	{"blue",              MT65XX_LED_MODE_CUST_BLS_PWM, (int)lm3533_blue_brightness_control,{0}},  //20140530 tracy modify for rgb led--
	{"jogball-backlight", MT65XX_LED_MODE_NONE, -1,{0}},
	{"keyboard-backlight",MT65XX_LED_MODE_NONE, -1,{0}},
	{"button-backlight",  MT65XX_LED_MODE_NONE, -1,{0}},
	{"lcd-backlight",     MT65XX_LED_MODE_CUST_BLS_PWM, (int)lm3533_backlight_control,{0}}, //20140422 tracy modify for backlight control
};
