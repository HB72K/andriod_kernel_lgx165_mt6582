...
extern int lm3533_backlight_control(unsigned long brightness);//20140422 tracy modify for backlight control
 //20140530 tracy add for rgb led++
extern int lm3533_blue_brightness_control(unsigned long brightness);
extern int lm3533_green_brightness_control(unsigned long brightness);
extern int lm3533_red_brightness_control(unsigned long brightness);
 //20140530 tracy add for rgb led--
